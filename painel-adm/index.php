...
<html lang="pt-br">
    ...
    <head>
        ...
        <!-- Linkagem do CSS padrao do template-->
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- pessoas  -->
                <!-- ao clicar em instrutor o conteudo da var $menu1 sera carregado na pag principal -->
                <li class="nav-item">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- se a url estiver "vazia" (localhost/proj-estudos-oficina/painel-adm/index.php) isto é  -->
                        <!-- chamando nada, se o conteudo da var pag for vazio, conteudo da pagina principal sera o que tem em home.php -->
                        <?php if (@$pag == null) { 
                        ...
                        // localhost/proj-estudos-oficina/painel-adm/index.php?pag=mecanicos
                        // a var pag tem como valor mecanicos, mecanicos é o conteudo de $menu1
